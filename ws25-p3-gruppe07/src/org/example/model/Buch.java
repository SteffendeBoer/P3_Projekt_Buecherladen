...
public class Buch {
    ...
    public Buch(String titel, String isbn, String autor, String sprache, int seitenanzahl,
                int erscheinungsjahr, double preis, boolean istVerfuegbar) {
        this.titel = titel;
        this.isbn = isbn;
        this.autor = autor;
    ...
    public void setIstVerfuegbar(boolean status){
        this.istVerfuegbar = status;
    }
    
    @Override
    public String toString() {
        return getTitel() + " (ISBN: " + getIsbn() + ")";
    }
    // Datenspeicherung
    public String toCSV() {
